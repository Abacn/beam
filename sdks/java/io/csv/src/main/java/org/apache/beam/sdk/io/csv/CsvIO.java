...
public class CsvIO {
   ...
   * and {@link Class<T>}.
   */
  public static <T> PTransform<PCollection<String>, PCollection<T>> parse(
      Class<T> klass, CSVFormat csvFormat) {
   ...
   * Schema}.
   */
  public static PTransform<PCollection<String>, PCollection<Row>> parseRows(
