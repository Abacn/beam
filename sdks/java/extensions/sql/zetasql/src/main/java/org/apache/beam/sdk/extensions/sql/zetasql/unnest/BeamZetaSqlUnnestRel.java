 ...
 * {@link ZetaSqlUnnest}.
 *
 * <p>This class is a copy of {@link org.apache.beam.sdk.extensions.sql.impl.rel.BeamUnnestRel}
...
public class BeamZetaSqlUnnestRel extends ZetaSqlUnnest implements BeamRelNode {
  ...
  public ZetaSqlUnnest copy(RelTraitSet traitSet, RelNode input) {
    return new BeamZetaSqlUnnestRel(getCluster(), traitSet, input, unnestType, unnestIndices);
  }
